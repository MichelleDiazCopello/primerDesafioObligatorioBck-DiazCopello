...
// Debe contar con el método “agregarEvento” El cual recibirá los siguientes parámetros: nombre, lugar, precio (deberá agregarse un 0.15 del valor original), capacidad (50 por defecto), fecha (hoy por defecto)
...
// Debe contar con un método “agregarUsuario” El cual recibirá: id del evento (debe existir, agregar validaciones), id del usuario
...
// Debe contar con un método “ponerEventoEnGira” El cual recibirá: id del evento, nueva localidad, nueva fecha.
...
ticketManager.agregarEventos ( "Recital de Andrea Boccelli", "Luna Park", 500, 10000 );
